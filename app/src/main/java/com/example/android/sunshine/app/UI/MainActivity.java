        ...
        if (findViewById(R.id.weather_detail_container) != null) {
            ...
            if (savedInstanceState == null) {
                getSupportFragmentManager().beginTransaction()
                        .replace(R.id.weather_detail_container, new com.example.android.sunshine.app.UI.DetailFragment(), DETAILFRAGMENT_TAG)
                        .commit();
            }
        } else {
            mTwoPane = false;
    ...
    * */
    ...
    protected void onResume() {
        ...
        if (location != null && !location.equals(mLocation)) {
            ...
            com.example.android.sunshine.app.UI.DetailFragment df = (com.example.android.sunshine.app.UI.DetailFragment)getSupportFragmentManager().findFragmentByTag(DETAILFRAGMENT_TAG);
            if ( null != df ) {
    ...
    * */
    ...
    public void onItemSelected(Uri contentUri,int position,View view) {
        if (mTwoPane) {
            ...
            args.putParcelable(com.example.android.sunshine.app.UI.DetailFragment.DETAIL_URI, contentUri);
